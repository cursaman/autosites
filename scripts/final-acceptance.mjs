...
try {
  ...
  for (const copy of ["무엇을 할지 고르면", "총 45개", "대화 · 기획", "조사 · 학습", "이미지 · 디자인", "코딩 · 웹 제작", "저장 · 배포 · 데이터", "처음이라면 이 세 개만", "ChatGPT", "Le Chat", "NotebookLM", "WolframAlpha", "Canva AI", "Microsoft Designer", "Codex", "Bolt", "Railway"]) assert(aiLinksHtml.includes(copy), `AI 링크 허브 누락: ${copy}`);
  assert((aiLinksHtml.match(/공식 사이트 새 창으로 열기/g) ?? []).length >= 45, "운영 AI 링크 허브의 공식 링크가 45개가 아닙니다.");
