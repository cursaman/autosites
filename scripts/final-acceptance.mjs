...
try {
  ...
  for (const copy of ["코딩 없이", "말 한마디에서", "이런 분께 추천합니다", "무엇을 만들 수 있나요?", "4주 동안 하나의", "계속 미루면 홈페이지는", "2기는 10월 10일 시작", "당근에서 남은 자리 문의하기", "처음 시작하는 사람을 위한 실전 클래스"]) {
