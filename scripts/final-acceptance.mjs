...
try {
  ...
  for (const copy of ["4주 만에 내 홈페이지를 만듭니다.", "수업에서 배우는 제작 방식", "바이브코딩 흐름 안내", "2시간 수업표", "GitHub 저장소 생성·첫 Push", "1기 교육이 진행 중입니다.", "50,000원", "별도의 장소 이용료 없이", "오후 6시 정시 시작", "건물 주차 가능", "커피긱스 2층 8인룸", "당근 모임에서 문의하기"]) {
