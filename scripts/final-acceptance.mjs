...
try {
  ...
  for (const copy of ["처음 한 번만,", "Google 계정 만들기 · Chrome 통일", "계정과 브라우저를 섞지 마세요.", "Windows 기본 브라우저를 Chrome으로 설정", "Edge에서 다른 계정으로 인증하지 않기", "ChatGPT 가입", "Codex", "GitHub", "Vercel", "Supabase 가입 · 계정 확인", "Sign in with GitHub", "Supabase 가입·대시보드 열기", "Supabase 프로젝트 연결 — 필요할 때만"]) {
