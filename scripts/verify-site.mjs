...
try {
  ...
  for (const copy of ["디자인·코딩 참고자료", "AI·홈페이지 학습", "수업용 크롬 확장 프로그램", "디자인 참고 사이트", "웹 개발 문서", "아이콘 참고 사이트", "AI Together 참고자료 전체보기"]) assert(resourcesHtml.includes(copy), `무료 자료 페이지의 AI Together 참고자료 누락: ${copy}`);
  assert(resourcesHtml.includes("https://ai-together-mu.vercel.app/resources"), "무료 자료 페이지에 AI Together 외부 링크가 없습니다.");
