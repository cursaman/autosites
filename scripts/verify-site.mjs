...
try {
  ...
  for (const copy of ["4주 뒤, 직접 만든", "당근에서 남은 자리 문의하기", "지금 할 일", "4주 과정 문의", "4주 뒤 내 손에 남는 것", "실제로 열리는 운영 URL", "채팅 요청부터 실제 배포까지", "AutoSites 운영자", "1기 교육이 이번 주 마무리됩니다.", "75%", "MOVIEBOX", "수강생 작품 보기", "2기는 10월 10일 토요일에 시작합니다.", "2026. 10. 10–10. 31", "2기 남은 자리 문의하기", "2시간 수업표", "80,000원"]) {
