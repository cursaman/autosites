...
export default function AboutPage() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.header}><Link className={styles.brand} href="/" aria-label="AutoSites 홈"><Image src={autoSitesLogo} alt="" width={40} height={40} priority /><span>AutoSites</span></Link><CourseSelector items={siteContent.navigation} /><a className={styles.headerCta} href={recruitmentUrl}>자리 문의</a></header>
