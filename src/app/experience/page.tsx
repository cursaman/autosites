...
export default function ExperiencePage() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.header}><Link className={styles.brand} href="/" aria-label="AutoSites 홈으로 이동"><Image src={autoSitesLogo} alt="" width={40} height={40} priority />AutoSites</Link><nav aria-label="체험 수업 메뉴"><a href="#result">완성 결과</a><a href="#schedule">홈페이지 체험</a><a href="#album">앨범 만들기</a><a href="#prompts">질문 예시</a><a href="#preparation">준비물</a></nav><a className={styles.headerAction} href={recruitmentUrl}>체험 문의</a></header>
