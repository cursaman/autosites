...
export const metadata: Metadata = {
  ...
  description: "코딩 경험 없이 AI와 함께 2시간 동안 내 소개 홈페이지를 만들고 실제 인터넷 주소로 공개하는 초보자 체험 수업입니다.",
  alternates: { canonical: "/experience" },
  openGraph: { type: "article", locale: "ko_KR", url: "/experience", title: "하루 2시간 AI 홈페이지 체험 | AutoSites", description: "아이디어를 말하고, 화면을 수정하고, 실제 홈페이지 주소까지 완성하는 2시간 체험", images: [{ url: "/og.png", width: 1200, height: 630, alt: "AutoSites 하루 2시간 AI 홈페이지 체험" }] },
...
export default function ExperiencePage() {
  ...
  return <div className={styles.page}>
    ...
    <header className={styles.header}><Link className={styles.brand} href="/" aria-label="AutoSites 홈으로 이동"><Image src={autoSitesLogo} alt="" width={40} height={40} priority />AutoSites</Link><nav aria-label="체험 수업 메뉴"><a href="#result">완성 결과</a><a href="#schedule">2시간 진행표</a><a href="#preparation">준비물</a></nav><a className={styles.headerAction} href={recruitmentUrl}>체험 문의</a></header>
