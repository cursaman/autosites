...
export default function ResourcesPage() {
  ...
  return <div className={styles.page}>
    ...
    <main id="resources-main" tabIndex={-1}>
      ...
      <section className={`${styles.externalHub} ${styles.container}`} aria-labelledby="external-hub-title"><div><p className={styles.eyebrow}>AI TOGETHER RESOURCES</p><h2 id="external-hub-title">디자인·코딩 참고자료도<br />한곳에서 확인하세요.</h2><p>AI 기초학습, 수업용 크롬 확장 프로그램, 디자인 참고 사이트, 웹 개발 문서와 아이콘 자료를 모아둔 별도 안내입니다.</p></div><Link href="/learning-resources">AI Together 자료 안내 보기 <span>→</span></Link></section>
