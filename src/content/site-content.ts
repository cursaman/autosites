  ...
  aiLinks: {
    categories: [
      { id: "conversation", number: "01", title: "대화 · 기획", description: "아이디어를 정리하고 계획표, 문구, 질문의 초안을 만들 때 시작하는 도구입니다.", tools: [
        ...
        { name: "Microsoft Copilot", purpose: "업무·웹 질문", description: "Microsoft 환경에서 질문하고 글과 아이디어를 정리할 때 활용합니다.", href: "https://copilot.microsoft.com/", tag: "Microsoft 중심" },
        { name: "Poe", purpose: "여러 AI 비교", description: "여러 종류의 AI 봇을 한곳에서 선택하며 답변 방식을 비교합니다.", href: "https://poe.com/", tag: "모델 탐색" },
        { name: "Grok", purpose: "대화·정보 탐색", description: "질문과 아이디어 정리, 실시간 주제 탐색에 활용하는 대화형 AI입니다.", href: "https://grok.com/", tag: "대화형 AI" },
        { name: "Le Chat", purpose: "빠른 대화·문서 작업", description: "Mistral AI의 대화 도구로 질문, 글쓰기와 문서 분석에 활용합니다.", href: "https://chat.mistral.ai/", tag: "Mistral AI" },
        { name: "DeepSeek", purpose: "추론·코드 질문", description: "복잡한 질문의 풀이 과정과 코드 관련 아이디어를 살펴볼 때 활용합니다.", href: "https://chat.deepseek.com/", tag: "추론 중심" },
        { name: "Meta AI", purpose: "일상 질문·이미지", description: "웹과 Meta 앱 환경에서 질문하고 아이디어나 이미지를 만듭니다.", href: "https://www.meta.ai/", tag: "Meta 환경" },
      ] },
      { id: "research", number: "02", title: "조사 · 학습", description: "자료를 모으고 출처를 확인하거나, 내가 가진 문서를 바탕으로 공부할 때 사용합니다.", tools: [
        ...
        { name: "Elicit", purpose: "논문 조사", description: "연구 질문에 맞는 논문을 찾고 근거와 내용을 구조적으로 정리합니다.", href: "https://elicit.com/", tag: "연구 중심" },
        { name: "Consensus", purpose: "연구 근거 검색", description: "과학 논문을 중심으로 질문에 관련된 연구 결과와 출처를 확인합니다.", href: "https://consensus.app/", tag: "논문 검색" },
        { name: "SciSpace", purpose: "논문 읽기·설명", description: "논문을 검색하고 어려운 내용에 질문하며 이해를 돕는 데 활용합니다.", href: "https://scispace.com/", tag: "논문 학습" },
        { name: "You.com", purpose: "웹 조사·리서치", description: "웹 자료를 바탕으로 질문하고 조사 결과와 관련 출처를 찾아봅니다.", href: "https://you.com/", tag: "웹 리서치" },
        { name: "WolframAlpha", purpose: "계산·지식 확인", description: "수학, 과학과 통계 질문을 데이터와 계산 결과로 확인합니다.", href: "https://www.wolframalpha.com/", tag: "계산 중심" },
        { name: "Semantic Scholar", purpose: "학술 논문 검색", description: "주제와 저자를 기준으로 학술 논문과 인용 관계를 탐색합니다.", href: "https://www.semanticscholar.org/", tag: "학술 검색" },
      ] },
      { id: "visual", number: "03", title: "이미지 · 디자인", description: "앨범 사진을 변환하고 배너, 카드뉴스, 발표 자료용 이미지를 만들 때 사용합니다.", tools: [
        ...
        { name: "Leonardo.Ai", purpose: "이미지·영상 제작", description: "프롬프트로 시각 자료를 만들고 편집하거나 움직임을 더합니다.", href: "https://www.leonardo.ai/", tag: "창작 중심" },
        { name: "Ideogram", purpose: "글자가 있는 이미지", description: "포스터와 배너처럼 이미지 안의 문구가 중요한 시안을 만듭니다.", href: "https://ideogram.ai/", tag: "문자 표현" },
        { name: "Midjourney", purpose: "스타일 이미지", description: "다양한 화풍과 분위기의 고품질 콘셉트 이미지를 탐색합니다.", href: "https://www.midjourney.com/", tag: "콘셉트 작업" },
        { name: "Microsoft Designer", purpose: "배너·카드 디자인", description: "문장으로 이미지와 디자인을 만들고 사진과 배치를 편집합니다.", href: "https://designer.microsoft.com/", tag: "Microsoft 디자인" },
      ...
      { id: "building", number: "05", title: "코딩 · 웹 제작", description: "기획을 실제 화면과 소스 파일로 만들고 오류를 검사할 때 사용하는 제작 도구입니다.", tools: [
        ...
        { name: "Claude Code", purpose: "터미널 코딩 작업", description: "코드베이스를 이해하고 터미널에서 개발 작업을 수행하도록 요청합니다.", href: "https://claude.com/product/claude-code", tag: "개발 에이전트" },
        { name: "Cursor", purpose: "AI 코드 에디터", description: "코드 편집기 안에서 프로젝트를 탐색하고 수정 도움을 받습니다.", href: "https://cursor.com/", tag: "에디터 중심" },
        { name: "Replit", purpose: "브라우저 앱 제작", description: "별도 개발 환경 설치 없이 브라우저에서 앱을 만들고 실행합니다.", href: "https://replit.com/", tag: "브라우저 제작" },
        { name: "Bolt", purpose: "대화형 웹앱 제작", description: "브라우저에서 원하는 앱을 설명하고 코드와 화면을 함께 생성합니다.", href: "https://bolt.new/", tag: "빠른 프로토타입" },
      ...
      { id: "publishing", number: "06", title: "저장 · 배포 · 데이터", description: "AI 도구는 아니지만 만든 홈페이지를 보관하고 실제 주소로 공개하는 데 필요한 연결 도구입니다.", tools: [
        ...
        { name: "Firebase", purpose: "앱 데이터·인증", description: "Google 환경에서 인증, 데이터 저장과 호스팅 기능을 연결합니다.", href: "https://firebase.google.com/", tag: "Google 개발" },
        { name: "Netlify", purpose: "웹사이트 배포", description: "Git 저장소나 완성된 사이트 파일을 연결해 인터넷에 공개합니다.", href: "https://www.netlify.com/", tag: "배포 대안" },
        { name: "Cloudflare Pages", purpose: "정적 사이트 배포", description: "Git 저장소와 연결해 빠른 글로벌 네트워크에 사이트를 배포합니다.", href: "https://pages.cloudflare.com/", tag: "배포 대안" },
        { name: "Render", purpose: "웹 서비스 배포", description: "Git 저장소를 연결해 웹사이트와 백엔드 서비스를 운영합니다.", href: "https://render.com/", tag: "서비스 배포" },
        { name: "Railway", purpose: "앱·서버 배포", description: "애플리케이션과 데이터베이스를 연결하고 실행 환경을 배포합니다.", href: "https://railway.com/", tag: "백엔드 배포" },
        { name: "Neon", purpose: "Postgres 데이터베이스", description: "웹 서비스에서 사용할 서버리스 Postgres 데이터베이스를 준비합니다.", href: "https://neon.com/", tag: "데이터 저장" },
      ] },
    ],
  },
  workflow: {
